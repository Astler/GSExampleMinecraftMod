...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> CRACKED_STONE_STICK_BLOCK = BLOCKS.register("cracked_stone_stick_block", () -> new Block(Block.Properties.create(Material.ROCK).hardnessAndResistance(3.0F, 3.0F).harvestTool(ToolType.PICKAXE)));
